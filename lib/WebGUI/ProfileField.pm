...
sub formField {
	...
	my $default;
	if (defined $session{form}{$properties->{name}}) {
	...
	} elsif (!defined $u && defined $session{user}{$properties->{name}}) {
