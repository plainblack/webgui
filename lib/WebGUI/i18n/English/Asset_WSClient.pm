...
<li>To completely ignore a SOAP wobject, including any possible cached returns, pass a form input param of disableWobjects=<i>call</i> where call is the SOAP method.</li></ul></p>
|,
		lastUpdated => 1119981471,
	},
        ...
        '8 description' => {
                message => q|If you're using WebGUI macros in your query you'll want to check this box.<p></p>|,
                lastUpdated => 1119981444,
        },

        '13 description' => {
                message => q|How many rows should be displayed before splitting the results into separate pages? In other words, how many rows should be displayed per page?<p></p>|,
                lastUpdated => 1119981444,
        },

        '14 description' => {
                message => q|Because a SOAP call can return complex data structures, you'll need to specify which named variable is to be paginated.  If none is specified, no pagination will occur.<p></p>|,
                lastUpdated => 1119981444,
        },
...
<code>http://mydomain.com/cgi-bin/soaplistener.pl</code><p></p>|,
        ...
        '4 description' => {
                message => q|The SOAP method is the name of the function to be invoked by the SOAP server. Include any extra parameters in the SOAP Call Parameters field below.<p></p>|,
                lastUpdated => 1119981444,
        },
...
property allows you to override the default MIME type for this page.|,
        ...
        '9 description' => {
                message => q|If you want to display debugging and error messages on the page, check this box.<p></p>|,
                lastUpdated => 1119981444,
        },
        ...
        '28 description' => {
                message => q|By default, SOAP calls are cached uniquely for each user session.  By selecting "Global" call returns can be shared between users.<p></p>|,
                lastUpdated => 1119981444,
        },

        '27 description' => {
                message => q|Number of seconds a SOAP return will be cached.  Set to 1 to essentially skip caching.<p></p>|,
                lastUpdated => 1119981444,
        },
