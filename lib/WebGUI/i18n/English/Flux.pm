package WebGUI::i18n::English::Flux;
...
our $I18N = { 
	...
	'flux notice' => {
		message 	=> q|Flux Notice|,
		lastUpdated	=> 0,
		context		=> q|an email subject heading for generic flux notification emails|,
	},
	...
	'inFluxCreditAvailable help' => {
		message 	=> q|The amount of in-flux credit the user has.|,
		lastUpdated	=> 0,
		context		=> q|a help description|,
	},

	'inFluxCreditDeduction help' => {
		message 	=> q|The amount of in-flux credit that has been applied to this order.|,
		lastUpdated	=> 0,
		context		=> q|a help description|,
	},
	...
	'cart template help' => {
		message 	=> q|This template determines what the fluxping cart looks like.|,
		lastUpdated	=> 0,
		context		=> q|a help description|,
	},
	...
	'who can manage help' => {
		message 	=> q|The group that has management rights over flux.|,
		lastUpdated	=> 0,
		context		=> q|a help description|,
	},
	...
	'add credit message' => { 
		message => q|%s was added to %s's in-flux credit account, for a total credit of %s.|,
		lastUpdated => 0,
		context => q|field label|
	},
	...
	'in flux credit' => { 
		message => q|In-Flux Credit|,
		lastUpdated => 0,
		context => q|a label in the cart|
	},

	'in flux credit used' => { 
		message => q|In-Flux Credit Used|,
		lastUpdated => 0,
	...
	'item' => { 
		message => q|Item|,
		lastUpdated => 0,
		context => q|a column heading label in the fluxping cart|
	},
	...
	'continue fluxping button' => { 
		message => q|Continue Fluxping|,
		lastUpdated => 0,
		context => q|a button the user clicks on to go back to fluxping after viewing the cart|
	},

	'flux' => { 
		message => q|Flux|,
		lastUpdated => 0,
		context => q|the title of all flux related stuff in the admin console|
	},
...
'weekly' => {
    ...
    'import' => {
        ...
        context => q|Label for bringing data into the Flux (Tax, Product, etc.)|
    },

	'export' => {
		message => q|Export|,
		lastUpdated => 1212550978,
		context => q|Label for taking data out of the Flux (Tax, Product, etc.)|,
	},
    ...
    'fluxCreditDeduction' => {
        message => q|The unformatted amount of flux credit used in this transaction.|,
        lastUpdated => 1213132212,
        context => q|Template variable for email receipt template|,
    },
