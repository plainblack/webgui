...
This plugin expects that you set up the following recipes in your iTransact account for recurring transactions. Be very careful to enter the recipe names exactly as given below.<br />
...
Please note that some of these recipes are only roughly correct. They don't 'fit' exactly in a whole year. Below the affected recipes are given together with their difference on a year's basis. <br />
<ul>
