...
sub handler {
    ...
    if ( $form->process("step") eq "2" ) {
        ...
        $output .= ' <p>' . $i18n->get( 'why to send', 'Activity_SendWebguiStats' ) . '</p>
            ...
            <p><a href="'
            . $session->url->gateway( undef, "step=sitestarter" ) . '">'
            . $i18n->get( 'disable', 'Activity_SendWebguiStats' )
            . '</a> &nbsp; &nbsp; &nbsp;
                <a href="'
            . $session->url->gateway( undef, "step=sitestarter;enableStats=1" ) . '">'
            . $i18n->get( 'enable', 'Activity_SendWebguiStats' )
            . '</a></p>
            ';
    } ## end elsif ( $session->form->process...)
        ...
        $output .= ' <p>' . $i18n->get('site starter body') . '</p>
            <p><a href="'
            . $session->url->gateway( undef, "step=7" ) . '">'
            . $i18n->get('no thanks')
            . '</a> &nbsp; &nbsp; &nbsp;
        ...
        $style->setLink( $url->extras('/yui/build/colorpicker/assets/skins/sam/colorpicker.css'),
            { type => 'text/css', rel => "stylesheet" } );
        ...
        $style->setLink( $url->extras("/styleDesigner/styleDesigner.css"),
...
#pageUtilityContainer { font-size: 9pt; background-color: '
            . $form->get("utilityBackgroundColor")
            . '; color: '
            . $form->get("utilityTextColor") . '; }
#pageHeaderContainer { background-color: '
            . $form->get("headerBackgroundColor")
            . '; color: '
            . $form->get("headerTextColor") . '; }
...
#pageBodyContainer { background-color: '
            . $form->get("contentBackgroundColor")
            . '; color: '
            . $form->get("contentTextColor") . '; }
#mainNavigationContainer { min-height: 300px; padding: 5px; float: left; width: 180px; font-size: 10pt; background-color: '
            . $form->get("navigationBackgroundColor") . '; }
...
#pageFooterContainer { text-align: center; background-color: '
            . $form->get("footerBackgroundColor")
            . '; color: '
            . $form->get("footerTextColor") . '; }
...
<div id="pageWidthContainer">
    ...
    <div id="pageHeaderContainer">
        ...
        <div id="pageHeaderLogoContainer"><a href="^H(linkonly);"><img src="'
            . $form->get("logoUrl")
            . '" id="logo" alt="logo" /></a></div>
        <div class="clearFloat"></div>
    </div>
...
return props[propName];
    ...
    $page .= ' </style> </head> <body> 
         ...
         <img src="'
        . $session->url->extras('background.jpg')
        . '" style="border-style:none;position: absolute; top: 0; left: 0; width: 100%; height: 1000px; z-index: 1;" />
	</body> </html>';
