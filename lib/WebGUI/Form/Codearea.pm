...
sub toHtml {
	...
	$self->set("extras", $self->get('extras') . ' style="width: 99%; min-width: 440px; height: 400px" onkeypress="return TabFix_keyPress(event)" onkeydown="return TabFix_keyDown(event)"');	
