replace into EventsCalendar select widgetId from widget where widgetType='EventsCalendar';
alter table groups add column expireAfter int not null default 314496000;
...
delete from style where styleId < 26;
...
delete from groups where groupId < 26;
...
delete from page where pageId=5;
