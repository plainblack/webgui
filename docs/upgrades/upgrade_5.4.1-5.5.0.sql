...
create table discuss (
  discussId int not null primary key,
...
create table discussReplacement (
  discussReplacementId int not null primary key,
  pattern varchar(255),
...
create table discussPostAttachment (
  discussPostAttachmentId int not null primary key,
  postId int not null,
  filename varchar(255)
);

create table discussThread (
...
create table discussThreadSubscription (
   discussThreadId int not null,
   userId int not null,
   primary key (discussThreadId, userId)
);

create table discussSubscription (
   discussId int not null,
   userId int not null,
   primary key (discussId, userId)
);
