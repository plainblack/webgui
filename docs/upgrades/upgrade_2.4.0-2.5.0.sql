alter table widget add column position char(1) not null default 'A';
alter table page add column template varchar(30) not null default 'Default';
update widget set position='A';
update page set template='Default';
delete from help;
