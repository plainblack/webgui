alter table link add column newWindow int not null default 0;
delete from international where language='Deutsche' and internationalId<307;
update users set language='Deutsch' where language='Deutsche';
alter table international add column namespace varchar(30) not null default 'WebGUI' after internationalId;
alter table international drop primary key;
alter table international add primary key(internationalId,namespace,language);
alter table help add column namespace varchar(30) not null default 'WebGUI' after helpId;
alter table help drop primary key;
alter table help add primary key(helpId,namespace,language);
create table LinkList (
	widgetId int not null primary key,
	indent int not null,
	lineSpacing int not null default 1,
	bullet varchar(255) not null default '&middot;'
);
alter table link rename LinkList_link;
insert into LinkList (widgetId) select distinct widgetId from LinkList_link;
create table EventsCalendar (
	widgetId int not null primary key
);
alter table event rename EventsCalendar_event;
insert into EventsCalendar (widgetId) select distinct widgetId from EventsCalendar_event;
create table FAQ (
	widgetId int not null primary key
);
alter table faqQuestion rename FAQ_question;
insert into FAQ (widgetId) select distinct widgetId from FAQ_question;
alter table pollAnswer rename Poll_answer;
alter table submission rename UserSubmission_submission;
alter table users add column firstName varchar(50) after language;
alter table users add column middleName varchar(50) after firstName;
alter table users add column lastName varchar(50) after middleName;
alter table users add column aim varchar(30);
alter table users add column msnIM varchar(30);
alter table users add column yahooIM varchar(30);
alter table users add column homeAddress varchar(128);
alter table users add column homeCity varchar(30);
alter table users add column homeState varchar(30);
alter table users add column homeZip varchar(15);
alter table users add column homeCountry varchar(30);
alter table users add column homePhone varchar(30);
alter table users add column workAddress varchar(128);
alter table users add column workCity varchar(30);
alter table users add column workState varchar(30);
alter table users add column workZip varchar(15);
alter table users add column workCountry varchar(30);
alter table users add column workPhone varchar(30);
alter table users add column cellPhone varchar(30);
alter table users add column pager varchar(30);
alter table users add column gender varchar(6);
alter table users add column birthdate varchar(30);
alter table users add column homepage text;
alter table help change column language language varchar(30) not null default 'English';
update help set language='English' where language='US English';
create table helpSeeAlso (
	seeAlsoId int not null primary key,
	helpId int,
	namespace varchar(30)
);
delete from international where language='English' or language='Deutsch';
...
delete from page where pageId=2 or pageId=3;
