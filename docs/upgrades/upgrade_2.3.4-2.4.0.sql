...
alter table SiteMap change showOnlyThisLevel depth int not null default 0;
alter table SiteMap add column indent int not null default 5;
alter table SiteMap add column bullet varchar(30) not null default '&middot';
alter table SiteMap add column lineSpacing int not null default 1;
alter table message add column subId int;
alter table message rename discussion;
delete from help;
