alter table SQLReport add column preprocessMacros int not null default 0;
alter table SQLReport add column debugMode int not null default 0;
alter table users change identifier identifier varchar(128);
delete from help;
...
update page set styleId=5 where pageId=3;
